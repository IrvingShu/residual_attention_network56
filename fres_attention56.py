...
def attention_module_stage1(data, **kwargs):
    # 112,112
    attentionA_1_trunk_res2 = skip_residual_unit(data, 256, 1, True, "AttentionA_1_trunk_res2_branch1", **kwargs)
    attentionA_1_trunk_res3 = skip_residual_unit(attentionA_1_trunk_res2, 256, 1, True, "AttentionA_1_trunk_res3_branch1", **kwargs)

    attentionA_1_mask_down_sample_pool1 = mx.sym.Pooling(data=data, kernel=(3, 3), stride=(2,2), pad=(1,1), pool_type='max')
    attentionA_1_mask_down_sample_res1_1 = skip_residual_unit(attentionA_1_mask_down_sample_pool1, 256, 1, True, "attentionA_1_mask_down_sample_res1_1_branch1", **kwargs)

    #right branch
    attentionA_1_mask_skip_res1 = skip_residual_unit(attentionA_1_mask_down_sample_res1_1, 256, 1, True, "attentionA_1_mask_skip_res1_branch1", **kwargs)
    ...
    attentionA_1_mask_down_sample_res2_1 = skip_residual_unit(attentionA_1_mask_down_sample_pool2, 256, 1, True, "attentionA_1_mask_down_sample_res2_1_branch1", **kwargs)
    ...
    attentionA_1_mask_down_sample_res_3_1 = skip_residual_unit(attentionA_1_mask_down_sample_pool3, 256, 1, True, "attentionA_1_mask_down_sample_res3_1_branch1", **kwargs)

    attentionA_1_mask_down_sample_res_3_2 = skip_residual_unit(attentionA_1_mask_down_sample_res_3_1, 256, 1, True, "attentionA_1_mask_down_sample_res3_2_branch1", **kwargs)
    ...
    attentionA_1_mask_skip_res2 = skip_residual_unit(attentionA_1_mask_down_sample_res2_1, 256, 1, True, "attentionA_1_mask_skip_res2", **kwargs)
    ...
    attention_A_1_mask_up_sample_res2_1 = skip_residual_unit(attention_A_1_mask_up_sample2, 256, 1, True, "attentionA_1_mask_up_sample_res2_1_branch1", **kwargs)
    ...
    attention_A_1_mask_up_sample_res1_1 = skip_residual_unit(attention_A_1_up_sample1, 256, 1, True, "attentionA_1_mask_up_sample_res1_1_branch")
    ...
    attention_A_1_mask = mask_linear(attention_A_1_mask_up_sample_interp_1, 256, 'attentionA_1_mask', **kwargs)

    attention_A_1_fusion = (1 + attention_A_1_mask) * attentionA_1_trunk_res3

    attentionA_1 = skip_residual_unit(attention_A_1_fusion, 256, 1, True, "attentionA_1_branch1")

    return attentionA_1


def attention_module_stage2(data, **kwargs):

    attentionB_1_trunk_res2 = skip_residual_unit(data, 512, 1, True, 'attentionB_1_trunk_res2_branch1', **kwargs)
    attentionB_1_trunk_res3 = skip_residual_unit(attentionB_1_trunk_res2, 512, 1, True, 'attentionB_1_trunk_res3_branch1', **kwargs)

    attentionB_1_mask_down_sample_pool1 = mx.sym.Pooling(data=data, kernel=(3, 3), stride=(2,2), pad=(1,1), pool_type='max')
    attentionB_1_mask_down_sample_res1_1 = skip_residual_unit(attentionB_1_mask_down_sample_pool1, 512, 1, True, 'attentionB_1_mask_down_sample_res1_1_branch1', **kwargs)
    ...
    attentionB_1_mask_down_sample_res2_1 = skip_residual_unit(attentionB_1_mask_down_sample_pool2, 512, 1, True, 'attentionB_1_mask_down_sample_res2_1_branch1', **kwargs)
    attentionB_1_mask_down_sample_res2_2 = skip_residual_unit(attentionB_1_mask_down_sample_res2_1, 512, 1, True, 'attentionB_1_mask_down_sample_res2_2_branch1', **kwargs)
    ...
    attentionB_1_mask_skip_res1 = skip_residual_unit(attentionB_1_mask_down_sample_res1_1, 512, 1, True, 'attentionB_1_mask_skip_res1_branch1', **kwargs)

    attentionB_1_mask_up_sample1 = attentionB_1_mask_up_sample_interp2 + attentionB_1_mask_skip_res1

    attentionB_1_mask_up_sample_res1_1 = skip_residual_unit(attentionB_1_mask_up_sample1, 512, 1, True, 'attentionB_1_mask_up_sample_res1_1_branch1', **kwargs)
    ...
    attentionB_1_mask = mask_linear(attentionB_1_mask_up_sample_interp_1, 512, 'attentionB_1_mask', **kwargs)

    attentionB_1_fusion = (1 + attentionB_1_mask) * attentionB_1_trunk_res3

    attentionB_1 = skip_residual_unit(attentionB_1_fusion, 512, 1, True, 'attentionB_1_branch1', **kwargs)
    return attentionB_1


def attention_module_stage3(data, **kwargs):
    # left branch
...
def attention_residual_56(num_classes, **kwargs):
    ...
    attentionA_1 = attention_module_stage1(attentionA_1_trunk_res1, **kwargs)
    pre_res_2 = skip_residual_unit_follow_act(attentionA_1, 512, 2, False, 'pre_res_2_branch1', **kwargs)
    attentionB_1_trunk_res1 = skip_residual_unit(pre_res_2, 512, 1, True, 'AttentionB_1_trunk_res1', **kwargs)
    attentionB_1 = attention_module_stage2(attentionB_1_trunk_res1, **kwargs)
    ...
    attentionC_1 = attention_module_stage3(attentionC_1_trunk_res1, **kwargs)
